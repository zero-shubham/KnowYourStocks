export const elements = {
    inputStockName : document.querySelector('#stockName'),
    inputDataInterval : document.querySelector('.container__input-dropdown > select'),
    btnRetreive : document.querySelector('.container__input-btn'),
